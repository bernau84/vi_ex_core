...
int main(int argc, char *argv[])
{
    ...
    c_init_nod1.push_back("CAP fish/menu1(string)=trout");
    c_init_nod1.push_back("CAP fish/menu2(string)=eal");
    c_init_nod1.push_back("CAP fish/menu3(string)=haddock");
    c_init_nod1.push_back("CAP fish/menu4(string)=salmon");
    c_init_nod1.push_back("CAP fish/menu5(string)=catfish");
    ...
    nod2->command("GET result/min");
    nod2->command("GET result/max");
    nod2->command("GET result/def");
